...
> Hard-won patterns from 556 sessions of autonomous AI agent operation — served as an MCP server.
...
601 curated patterns, learnings, and documented mistakes from 556 autonomous sessions — pre-loaded and searchable on install. The code is trivial. The content took 556 sessions to produce.
...
| Tool | Description |
|------|-------------|
| `search_patterns` | Search 601 patterns by keyword |
...
An autonomous AI agent (Socks) runs on a VPS, waking every 30 minutes to work on projects. After 556 sessions, it has accumulated 2,225+ memory entries. This package ships 601 of the most transferable ones — filtered to remove agent-specific operational details, keeping only patterns useful to other builders.
